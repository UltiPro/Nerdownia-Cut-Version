<?php
include("PHP/SERWER/statusprogramow3.php");
...
<head>
	...
	<meta name="description" content="Strona nerdów - Counter Strike: Global Offensive!!!">
	<meta name="keywords" content="Serwery, Gry, Kursy, CS:GO">
	<meta name="author" content="Patryk Wójtowicz">
	<title>Nerdownia - CS:GO</title>	
	...
	<script type="text/javascript" src="JS/slidercsgo.js"></script>
</head>
			...
			<div class="lewy">
				...
				<section>
					<fieldset class="fieldset">
						<legend>CS:GO Turniejowy</legend>
						<ul>
							<li>Wersja Gry: Najnowsza</li>
							<li>Typ Serwera: PUBLIC, Matchmaking + Nożówka</li>
							<li>Adres IP: nerdownia.ddns.net</li>
							<li>Administracja: Ulti, Greges</li>
						...
						if($status=="Offline") echo '<a href="PHP/SERWER/wlaczcsgo.php" class="wlacz">Włącz</a>';
						if($status=="Online") echo '<a href="PHP/SERWER/wylaczcsgo.php" class="wylacz">Wyłącz</a>';
				...
				<header>
					<section>
						<div class="info"><fieldset class="infofieldset">
							...
							<div class="infotext">
							> Orginalną wersję gry można pobrać na stronie: <a href="https://store.steampowered.com/app/730/CounterStrike_Global_Offensive/?l=polish" target="blank" class="odsylacze">>STEAM<</a><br />
							<hr />
