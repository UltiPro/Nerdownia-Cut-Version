...
<head>
	...
	<meta name="description" content="Strona nerdów - Błąd logowania!!!">
	<meta name="keywords" content="Serwery, Gry, Kursy, Błąd logowania">
	<meta name="author" content="Patryk Wójtowicz">
	<title>Nerdownia - Błąd Logowania</title>	
...
<div class="statycznetlo"><img src="..\PICTURES\LOGOWANIE\tlo.jpg" class="szerokosctla"></div>
		<header>
			<article>	
				<section>
					<fieldset class="blad">
						<div class="error">System Logowania oraz rejestracji jest obecnie wyłączony.<br /> Proszę sprubować później.</div>
