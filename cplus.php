...
<head>
	...
	<meta name="description" content="Strona nerdów - C++!!!">
	<meta name="keywords" content="Serwery, Gry, Kursy, C++">
	<meta name="author" content="Patryk Wójtowicz">
	<title>Nerdownia - C++</title>	
...
<!-- TREŚĆ -->
<main>
<div class="statycznetlo"><img src="PICTURES\KURSY\tlocplus.jpg" class="szerokosctla"></div>
	<div class="tresc">
	<!-- LEWY -->
		<article>
			<div class="lewy">
				...
				<section>
					<div>
						<a href="https://www.youtube.com/watch?v=ErOzmh3BiXU&list=PLOYHgt8dIdoxx0Y5wzs7CFpmBzb40PaDo" target="blank" class="kursa"><fieldset class="kursyt"><legend>YT - C++</legend></fieldset></a>
					</div>
				</section>
			</div>
		</article>
